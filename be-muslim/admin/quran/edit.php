...
?>
<?php
  $get_surah = mysqli_query($koneksi,"SELECT * FROM surah WHERE id_surah = '$id'");
            ...
            <div class="row mt">
              <div class="col-lg-12">
                      ...
                      <h4><i class="fa fa-angle-right"></i> Tambah Surah</h4>
                          ...
                          <div class="form-panel">
                        	...
                        	<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="nomor" value="<?php echo $r_surah['nomor']; ?>">
                                    </div>
                                </div>        
				...
				<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="surah" value="<?php echo $r_surah['nama_surah']; ?>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="tabel" value="<?php echo $r_surah['nama_tabel']; ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" class="form-control" name="ayat" value="<?php echo $r_surah['jumlah_ayat']; ?>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="arti" value="<?php echo $r_surah['arti_surah']; ?>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea id="editor" name="cerita"><?php echo $r_surah['cerita_dibalik']; ?></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <img src="<?php echo $url_gbr; ?>/surah/<?php echo $r_surah['gbr_surah'] ?>" width="200px" height="120px"><br>
                                        <input type="file" class="form-control" name="image" value="<?php echo $r_config['gbr_surah'] ?>">
                                    </div>
                                </div>
			      ...
			      $nomor = $_POST['nomor'];
                            ...
                            // if everything is ok, try to upload file
                                ...
                                if (move_uploaded_file($_FILES["image"]["tmp_name"], $target_file)) {
                                    ...
                                    $queryupdate = mysqli_query($koneksi, "UPDATE surah SET nomor = '$nomor', nama_surah = '$surah', nama_tabel = '$tabel', jumlah_ayat = '$ayat', jenis_surah = '$jenis', arti_surah = '$arti', cerita_dibalik = '$cerita', gbr_surah = '$image', updated_at = NOW() WHERE id_surah = '$id'");
                             ...
                             $queryupdate = mysqli_query($koneksi, "UPDATE surah SET nomor = '$nomor', nama_surah = '$surah', nama_tabel = '$tabel', jumlah_ayat = '$ayat', jenis_surah = '$jenis', arti_surah = '$arti', cerita_dibalik = '$cerita', updated_at = NOW() WHERE id_surah = '$id'");
