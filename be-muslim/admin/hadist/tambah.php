                      ...
                      <h4><i class="fa fa-angle-right"></i> Tambah Hadist</h4>
                          ...
                          <div class="form-panel">
                            ...
                            <form class="form-horizontal style-form" method="post" action="#">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea id="editor1" name="indo"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea id="editor2" name="inggris"></textarea>
                                    </div>
                                </div>
                          ...
                          <?php
                            if(isset($_POST['kirim'])){
                              ...
                              $insert = mysqli_query($koneksi,"INSERT INTO hadist (judul,oleh,isi,indo,inggris,created_at) VALUES ('$judul','$dari','$isi','$indo','$inggris',NOW())");
